        ...
        <div className="flex justify-between">
          <div className="w-[500px]">
            ...
            <div className="flex flex-col gap-4">
              <Link to={"tel:+1 (555) 123-4567"} className="relative w-[300px]">
                <MdLocalPhone className="text-[21px]" />
                <span className="absolute -top-[3px] left-8 w-full font-['Montserrat'] text-base leading-[24px] text-[#303030]">
                  +1 (555) 123-4567
                </span>
              </Link>
              <Link to={"mailto:information@eshop.com"} className="relative">
                <SlEnvolope className="text-[19px]" />
                <span className="absolute -top-[3px] left-8 w-full font-['Montserrat'] text-base leading-[24px] text-[#303030]">
              ...
              <Link
                ...
                className="relative"
              >
                <CiLocationOn className="text-[21px]" />
                <span className="absolute -top-[3px] left-8 w-full font-['Montserrat'] text-base leading-[24px] text-[#303030]">
        ...
        <div className="h-[1px] bg-[#E5E5E5] w-full mt-[80px]">
          <div className=" flex justify-between py-5">
            ...
            <div>
              <Link
                to={""}
                className="font-['Montserrat'] text-sm text-[#303030] px-3 border-r-1 border-[#303030] "
              >
                Privacy Policy
              </Link>
              <Link
